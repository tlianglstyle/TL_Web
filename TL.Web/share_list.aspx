<%@ Page Title="" Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true"
    CodeBehind="share_list.aspx.cs" Inherits="TL.Web.share_list" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link href="c/share_list.css" rel="stylesheet" type="text/css" />
    <script type="text/javascript">
        var role = <%=(TL.Data.UserInfo.GetUserInfo().ID == 2 ? "true" : "false") %>;
    </script>
    <script src="j/Mshare_list.js" type="text/javascript"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="content">
        <div class="wrap">
            ...
            <h3 class="p_title">
                <a href="share.aspx">图集目录</a></h3>
            <!--filter-->
            <div id="filter" class="shadow mt20 none">
                <div id="filter-color">
                    <div class="title">
                        风格</div>
                    <ul>
            ...
            <div id="center">
                <div class="fl item-order">
                    <a v="1" class="cur shadow" title="按最新排序">最新</a> <a v="2" class="shadow" title="按查看数排序">
                        查看</a> <a v="3" class="shadow" title="按推荐人数降序排序">推荐</a> <a v="4" class="shadow" title="按评论数排序">
                            评论</a>
                </div>
                <div class="fl ml10">
