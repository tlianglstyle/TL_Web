...
Handsontable.TableView = function (instance) {
  ...
  var $table = $('<table class="htCore" style="width:100%"><thead></thead><tbody></tbody></table>');
...
function createContextMenu() {
  var instance = this
    ...
    allItems = {
      "row_above": {name: "向上插入一行", disabled: isDisabled},
      "row_below": {name: "向下插入一行", disabled: isDisabled},
      "hsep1": "---------",
      "col_left": {name: "向左插入一列", disabled: isDisabled},
      "col_right": {name: "向右插入一列", disabled: isDisabled},
      "hsep2": "---------",
      "remove_row": {name: "移除该行", disabled: isDisabled},
      "remove_col": {name: "移除该列", disabled: isDisabled},
      "hsep3": "---------",
      "undo": {name: "撤销", disabled: function () {
        return !instance.isUndoAvailable();
      }},
      "redo": {name: "重做", disabled: function () {
...
var Cursor =
{
	...
	set: function(e)
	{
		...
		{
//			this.x = e.clientX + document.body.scrollLeft||document.docmentElement.scrollLeft + document.documentElement.scrollLeft;
//			this.y = e.clientY + document.body.scrollTop||document.docmentElement.scrollTop + document.documentElement.scrollTop;
		}
	}
};
Cursor.init();
